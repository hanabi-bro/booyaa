...
def write_sheet_title(ws:worksheet, row:int, col:int, value:str) -> worksheet:
...
def write_hedder_cell(ws:worksheet, row:int, col:int, value:str, width:int) -> worksheet:
    ws.cell(row=row, column=col).value = value
...
def write_cell(ws:worksheet, row:int, col:int, value:str, width:int|None=None) -> worksheet:
    ws.cell(row=row, column=col).value = value
